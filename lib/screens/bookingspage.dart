            ...
            child: Row(
              children: [
                ...
                decoration: BoxDecoration(
                 image: DecorationImage(image: NetworkImage(displaylist[2].url))
                ),
                ),
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                     Text(displaylist[2].title,style: TextStyle(fontSize: 15,fontWeight: FontWeight.bold),),
                    SizedBox(
                      height: 5,
                    ),
                    Text(displaylist[2].author,style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold),),
                     SizedBox(
                      height: 5,
                    ),
                    Text("10 Hours to issue",style: TextStyle(fontSize: 15,fontWeight: FontWeight.bold,color: Colors.red),
                    ),
